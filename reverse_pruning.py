...
def helper(model_name, output_dir, percentile):
    ...
    save_pruned_model(pruned_model, tokenizer, save_dir=os.path.join("Reverse Pruned Model", output_dir, f"{output_dir}-pruned-{percentile}p"))
...
if __name__ == "__main__":
    ...
    # os.makedirs(f"C:/T2430447/Pruned Model/{output_dir}", exist_ok=True)
    os.makedirs(os.path.join("Reverse Pruned Model", output_dir), exist_ok=True)
