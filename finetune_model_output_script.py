...
for value in values:
    ...
    for task_type in task_types:
        ...
        load_model(model_id, task_type=task_type, output_dir=output_dir, half_precision=half_precision, value=value, model_type="finetuned", chat_template=chat_template, batch_size=batch_size)
