...
def helper(model_name, output_dir, percentile):
    ...
    save_pruned_model(pruned_model, tokenizer, save_dir=os.path.join(VOLUME_PATH, "Pruned Model", output_dir, f"{output_dir}-pruned-{percentile}p"))



output_dir = "Qwen2.5-Coder-1.5B-Instruct"
# os.makedirs(f"D:\\T2430447\\Pruned Model\\{output_dir}", exist_ok=True)
os.makedirs(os.path.join(VOLUME_PATH, "Pruned Model", output_dir), exist_ok=True)
